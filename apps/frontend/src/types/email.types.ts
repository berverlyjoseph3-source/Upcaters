...
export interface EmailAgentConfig {
  maxEmailsPerFetch: number;           // Maximum emails to fetch in one request
  autoLabelEnabled: boolean;           // Enable automatic email labeling
  autoReplyThreshold: number;          // Confidence threshold for auto-reply suggestions
  syncIntervalMinutes: number;          // How often to sync emails
  enableSmartClassification: boolean;    // Enable AI-powered email classification
}